 ...
 * body containing a single reference to an object. Only <CODE>Serializable</CODE>
 * Java objects can be used.
 * 
 * <P>
 * If a collection of Java objects must be sent, one of the <CODE>Collection</CODE>
...
public interface ObjectMessage extends Message {
	 ...
	 * subsequent modifications of the object will have no effect on the <CODE>ObjectMessage</CODE>
	 * body.
	 * 
	 * @param object
	 *            the message's data
