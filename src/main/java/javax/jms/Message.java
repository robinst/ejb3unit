 ...
 * <UL>
 * <LI>Stream - A <CODE>StreamMessage</CODE> object's message body contains a
 ...
 * of name-value pairs, where names are <CODE>String</CODE> objects, and
 ...
 * <CODE>java.lang.String</CODE> object. This message type can be used to
 ...
 * 
 * <P>
 * The <CODE>JMSCorrelationID</CODE> header field is used for linking one
 * message with another. It typically links a reply message with its requesting
 * message.
 * 
 * <P>
 * <CODE>JMSCorrelationID</CODE> can hold a provider-specific message ID, an
 * application-specific <CODE>String</CODE> object, or a provider-native
 * <CODE>byte[]</CODE> value.
 * 
 * <H4>Message Properties</H4>
 * 
 * <P>
 * A <CODE>Message</CODE> object contains a built-in facility for supporting
 ...
 * name is set and it is either null or an empty string, an <CODE>IllegalArgumentException</CODE>
 * must be thrown.
 * 
 * <P>
 * Property values can be <CODE>boolean</CODE>, <CODE>byte</CODE>, <CODE>short</CODE>,
 ...
 * properties at this point, a <CODE>MessageNotWriteableException</CODE> is
 * thrown. If <CODE>clearProperties</CODE> is called, the properties can now
 ...
 * must be supported. The unmarked cases must throw a <CODE>JMSException</CODE>.
 ...
 * the <CODE>String</CODE> as a valid representation of the primitive.
 * 
 * <P>
 * A value written as the row type can be read as the column type.
 * 
 * <PRE> | | boolean byte short int long float double String
 * |---------------------------------------------------------- |boolean | X X
 ...
 * the <CODE>setObjectProperty</CODE> and <CODE>getObjectProperty</CODE>
 ...
 * 
 * <P>
 * The <CODE>setObjectProperty</CODE> method accepts values of class <CODE>Boolean</CODE>,
 * <CODE>Byte</CODE>, <CODE>Short</CODE>, <CODE>Integer</CODE>, <CODE>Long</CODE>,
 * <CODE>Float</CODE>, <CODE>Double</CODE>, and <CODE>String</CODE>. An
 * attempt to use any other class must throw a <CODE>JMSException</CODE>.
 * 
 * <P>
 * The <CODE>getObjectProperty</CODE> method only returns values of class
 ...
 * property values, use <CODE>getPropertyNames</CODE> to retrieve a property
 * name enumeration and then use the various property get methods to retrieve
 * their values.
 * 
 * <P>
 * A message's properties are deleted by the <CODE>clearProperties</CODE>
 ...
 * value. Only the <CODE>getStringProperty</CODE> and <CODE>getObjectProperty</CODE>
 ...
 * <CODE>valueOf(String)</CODE> conversion method with a null value.
 * 
 * <P>
 * The JMS API reserves the <CODE>JMSX</CODE> property name prefix for JMS
 ...
 * 
 * <P>
 * <CODE>JMSXGroupID</CODE> and <CODE>JMSXGroupSeq</CODE> are standard
 ...
 * 
 * <P>
 * The JMS API reserves the <CODE>JMS_<I>vendor_name</I></CODE> property
 ...
 * 
 * <P>
 * Each JMS provider supplies a set of message factories with its <CODE>Session</CODE>
 ...
 * means for a message not to be delivered depends on the <CODE>MessageConsumer</CODE>
 * being used (see {@link javax.jms.QueueReceiver QueueReceiver} and
 ...
 * 
 * <P>
 * A message selector is a <CODE>String</CODE> whose syntax is based on a
 ...
 * represented by doubled single quote; for example, <CODE>'literal'</CODE>
 * and <CODE>'literal''s'</CODE>. Like string literals in the Java
 ...
 * such as <CODE>57</CODE>, <CODE>-957</CODE>, and <CODE>+62</CODE>;
 * numbers in the range of <CODE>long</CODE> are supported. Exact numeric
 ...
 * numeric value with a decimal, such as <CODE>7.</CODE>, <CODE>-95.7</CODE>,
 * and <CODE>+6.2</CODE>; numbers in the range of <CODE>double</CODE> are
 ...
 * method <CODE>Character.isJavaLetter</CODE> returns true. This includes
 * <CODE>'_'</CODE> and <CODE>'$'</CODE>. A letter or digit is any
 * character for which the method <CODE>Character.isJavaLetterOrDigit</CODE>
 * returns true.
 * <LI>Identifiers cannot be the names <CODE>NULL</CODE>, <CODE>TRUE</CODE>,
 * and <CODE>FALSE</CODE>.
 * <LI>Identifiers cannot be <CODE>NOT</CODE>, <CODE>AND</CODE>, <CODE>OR</CODE>,
 * <CODE>BETWEEN</CODE>, <CODE>LIKE</CODE>, <CODE>IN</CODE>, <CODE>IS</CODE>,
 * or <CODE>ESCAPE</CODE>.
 ...
 * <LI>Message header field references are restricted to <CODE>JMSDeliveryMode</CODE>,
 * <CODE>JMSPriority</CODE>, <CODE>JMSMessageID</CODE>, <CODE>JMSTimestamp</CODE>,
 * <CODE>JMSCorrelationID</CODE>, and <CODE>JMSType</CODE>. <CODE>JMSMessageID</CODE>,
 * <CODE>JMSCorrelationID</CODE>, and <CODE>JMSType</CODE> values may be
 * null and if so are treated as a <CODE>NULL</CODE> value.
 * <LI>Any name beginning with <CODE>'JMSX'</CODE> is a JMS defined property
 * name.
 ...
 * <CODE>true</CODE> matches; a selector that evaluates to <CODE>false</CODE>
 ...
 * is supported.
 * <LI>Logical operators in precedence order: <CODE>NOT</CODE>, <CODE>AND</CODE>,
 * <CODE>OR</CODE>
 ...
 * to <CODE>NULL</CODE>, the value of the expression is unknown.
 * <LI>String and boolean comparison is restricted to <CODE>=</CODE> and
 * <CODE><></CODE>. Two strings are equal if and only if they contain the
 ...
 * <UL>
 * <LI><CODE>"age&nbsp;BETWEEN&nbsp;15&nbsp;AND&nbsp;19"</CODE> is equivalent
 * to <CODE>"age&nbsp;>=&nbsp;15&nbsp;AND&nbsp;age&nbsp;<=&nbsp;19"</CODE>
 * <LI><CODE>"age&nbsp;NOT&nbsp;BETWEEN&nbsp;15&nbsp;AND&nbsp;19"</CODE> is
 * equivalent to <CODE>"age&nbsp;<&nbsp;15&nbsp;OR&nbsp;age&nbsp;>&nbsp;19"</CODE>
 * </UL>
 * <LI><CODE><I>identifier</I> [NOT] IN (<I>string-literal1</I>,
 * <I>string-literal2</I>,...)</CODE> (comparison operator where <CODE><I>identifier</I></CODE>
 * has a <CODE>String</CODE> or <CODE>NULL</CODE> value)
 * <UL>
 * <LI><CODE>"Country&nbsp;IN&nbsp;('&nbsp;UK',&nbsp;'US',&nbsp;'France')"</CODE>
 * is true for <CODE>'UK'</CODE> and false for <CODE>'Peru'</CODE>; it is
 * equivalent to the expression <CODE>"(Country&nbsp;=&nbsp;'&nbsp;UK')&nbsp;OR&nbsp;(Country&nbsp;=&nbsp;'&nbsp;US')&nbsp;OR&nbsp;(Country&nbsp;=&nbsp;'&nbsp;France')"</CODE>
 * <LI><CODE>"Country&nbsp;NOT&nbsp;IN&nbsp;('&nbsp;UK',&nbsp;'US',&nbsp;'France')"</CODE>
 * is false for <CODE>'UK'</CODE> and true for <CODE>'Peru'</CODE>; it is
 * equivalent to the expression <CODE>"NOT&nbsp;((Country&nbsp;=&nbsp;'&nbsp;UK')&nbsp;OR&nbsp;(Country&nbsp;=&nbsp;'&nbsp;US')&nbsp;OR&nbsp;(Country&nbsp;=&nbsp;'&nbsp;France'))"</CODE>
 * <LI>If identifier of an <CODE>IN</CODE> or <CODE>NOT IN</CODE> operation
 * is <CODE>NULL</CODE>, the value of the operation is unknown.
 * </UL>
 * <LI><CODE><I>identifier</I> [NOT] LIKE <I>pattern-value</I> [ESCAPE
 * <I>escape-character</I>]</CODE> (comparison operator, where <CODE><I>identifier</I></CODE>
 * has a <CODE>String</CODE> value; <CODE><I>pattern-value</I></CODE> is a
 * string literal where <CODE>'_'</CODE> stands for any single character;
 * <CODE>'%'</CODE> stands for any sequence of characters, including the empty
 * sequence; and all other characters stand for themselves. The optional <CODE><I>escape-character</I></CODE>
 * is a single-character string literal whose character is used to escape the
 * special meaning of the <CODE>'_'</CODE> and <CODE>'%'</CODE> in <CODE><I>pattern-value</I></CODE>.)
 * <UL>
 ...
 * <LI>If <CODE><I>identifier</I></CODE> of a <CODE>LIKE</CODE> or <CODE>NOT
 * LIKE</CODE> operation is <CODE>NULL</CODE>, the value of the operation is
 * unknown.
 * </UL>
 * <LI><CODE><I>identifier</I> IS NULL</CODE> (comparison operator that
 ...
 * incorrect selector must result in a <CODE>JMSException</CODE>. JMS
 ...
 * 
 * <P>
 * As noted above, property values may be <CODE>NULL</CODE>. The evaluation
 ...
 * 
 * <P>
 * SQL treats a <CODE>NULL</CODE> value as unknown. Comparison or arithmetic
 * with an unknown value always yields an unknown value.
 * 
 * <P>
 * The <CODE>IS NULL</CODE> and <CODE>IS NOT NULL</CODE> operators convert
 * an unknown value into the respective <CODE>TRUE</CODE> and <CODE>FALSE</CODE>
 * values.
 * 
 * <P>
 ...
 * 
 * <P>
 * When used in a message selector, the <CODE>JMSDeliveryMode</CODE> header
 * field is treated as having the values <CODE>'PERSISTENT'</CODE> and <CODE>'NON_PERSISTENT'</CODE>.
 * 
 * <P>
 * Date and time values should use the standard <CODE>long</CODE> millisecond
 ...
 * produce millisecond values is to use <CODE>java.util.Calendar</CODE>.
 * 
 * <P>
...
public interface Message {
	 ...
	 * 
	 * <P>
	 * All <CODE>JMSMessageID</CODE> values must start with the prefix <CODE>'ID:'</CODE>.
	 ...
	 * calling the <CODE>MessageProducer.setDisableMessageID</CODE> method, a
	 ...
	 * <CODE>send</CODE> or <CODE>publish</CODE> method returns, it contains
	 ...
	 * calling the <CODE>MessageProducer.setDisableMessageTimestamp</CODE>
	 ...
	 * the array will not alter this message header.
	 * 
	 * <P>
	 * If a provider supports the native concept of correlation ID, a JMS client
	 * may need to assign specific <CODE>JMSCorrelationID</CODE> values to
	 ...
	 * its corresponding get method; their implementation may throw a <CODE>java.lang.UnsupportedOperationException</CODE>.
	 * 
	 * <P>
	 * The use of a <CODE>byte[]</CODE> value for <CODE>JMSCorrelationID</CODE>
	 * is non-portable.
	 ...
	 * If a provider supports the native concept of correlation ID, a JMS client
	 * may need to assign specific <CODE>JMSCorrelationID</CODE> values to
	 * match those expected by clients that do not use the JMS API. A <CODE>byte[]</CODE>
	 * value is used for this purpose. JMS providers without native correlation
	 * ID values are not required to support <CODE>byte[]</CODE> values. The
	 * use of a <CODE>byte[]</CODE> value for <CODE>JMSCorrelationID</CODE>
	 * is non-portable.
	 * 
	 * @param correlationID
	 ...
	 * 
	 * <P>
	 * The <CODE>JMSReplyTo</CODE> header field contains the destination where
	 ...
	 * reply it has just received. The client can use the <CODE>JMSCorrelationID</CODE>
	 ...
	 * 
	 * <P>
	 * The <CODE>JMSDestination</CODE> header field contains the destination
	 * to which the message is being sent.
	 * 
	 * <P>
	 * When a message is sent, this field is ignored. After completion of the
	 * <CODE>send</CODE> or <CODE>publish</CODE> method, the field holds the
	 * destination specified by the method.
	 * 
	 * <P>
	 * When a message is received, its <CODE>JMSDestination</CODE> value must
	 ...
	 * to <CODE>JMSType</CODE>, whether the application makes use of it or
	 * not. This ensures that the field is properly set for those providers that
	 * require it.
	 * 
	 * <P>
	 * To ensure portability, JMS clients should use symbolic values for <CODE>JMSType</CODE>
	 ...
	 * left unassigned. After completion of the <CODE>send</CODE> or <CODE>publish</CODE>
	 ...
	 * 
	 * <P>
	 * If the time-to-live is specified as zero, <CODE>JMSExpiration</CODE> is
	 ...
	 * has been stored as a property in the message with the equivalent <CODE>setObjectProperty</CODE>
	 * method call, or its equivalent primitive <CODE>set<I>type</I>Property</CODE>
	 * method.
	 * 
	 * @param name
