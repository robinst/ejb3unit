 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ApplicationException.java 1100 2006-08-16 13:05:31Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * An exception annotated with this annotation will be an application exception and then thrown to the user.<br>
