...
class BinderImpl implements Binder {
  ...
  final CreationListner crListner;
 ...
 * @param crListner 
   */
  public BinderImpl(Stage stage, Class<? extends Annotation>[] injectionMarkers, CreationListner crListner) {
	this.crListner = crListner;
    this.injectionMarkers = injectionMarkers;
   ...
   */
  public BinderImpl() {
    this(Stage.DEVELOPMENT, Ejb3Guice.markerToArray(Inject.class), null);
  }
  ...
  Injector createInjector() throws CreationException {
    ...
    injector = new InjectorImpl(
        proxyFactoryBuilder.create(), bindings, scopes, this.injectionMarkers, this.crListner);
