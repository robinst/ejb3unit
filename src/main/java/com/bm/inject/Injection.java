...
/**
 * A Dependency Injection factor creates Injections. A injection contaions the
 * object which will be injected and a handle which contains additional
 * information.
 * 
 * @author Daniel Wiese
 * @param <H> -
 *            the type of the handle object e.g. MOck object
 * 
 */
