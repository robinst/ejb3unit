...
public abstract class BaseSessionBeanTest<T> extends BaseTest {
     ...
     */
    public BaseSessionBeanTest(Class<T> sessionBeanToTest, Class[] usedEntityBeans) {
        super();
        SessionBeanIntrospector<T> intro = new SessionBeanIntrospector<T>(sessionBeanToTest);
     ...
     *            the inital data to create in the db
     */
    protected BaseSessionBeanTest(Class<T> sessionBeanToTest, SessionBeanIntrospector<T> intro,
