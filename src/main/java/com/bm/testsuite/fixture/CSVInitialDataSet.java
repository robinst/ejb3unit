...
public class CSVInitialDataSet<T> implements InitialDataSet {
	...
	private String buildInsertSQL() {
		...
		for (String stringProperty : this.propertyMapping) {
			...
			final PersistentPropertyInfo info = this.introspector
					.getPresistentFieldInfo(property);
	...
	private Property getPersistentFieldInfo(String property) {
		Property info = null;
	...
	private void setPreparedStatement(int index, PreparedStatement statement,
		...
		if (type.equals(String.class)) {
			...
			statement.setShort(index, Short.valueOf(value));
