...
public class BaseTest extends TestCase {
    ...
    /**
     * Sets a value for a field in the tested-bean instance. this method also tries to locate the
     * field in all superclasses of the specified object.
     *
     * @author Daniel Wiese
     * @since 02.05.2006
     * @param fieldName -
    ...
    public void setValueForField(Object forObject, String fieldName,
            Object toSet) {
        try {
            Class clazz = forObject.getClass();
