...
public class ClassAnnotationMetadata extends CommonAnnotationMetadata implements
	 ...
	 * that user has specified in its bean class. It is the interceptors defined
	 * in interceptor classes, not the bean class itself. Map&lt;interceptor
	 * type &lt;--&gt; List of methods/class corresponding to the
	 * interceptor&gt;
	 */
	...
	/**
	 * Object representing &#64;{@link javax.persistence.PersistenceContext}
	 * annotation.
	 */
	private List<JavaxPersistenceContext> javaxPersistencePersistenceContexts = null;

	/**
	 * Object representing &#64;{@link javax.persistence.PersistenceUnit}
	 * annotation.
	 */
	 ...
	 * 
	 * @param className
	 *            name of the class associated to these metadatas.
	 * @param ejbJarAnnotationMetadata
	 *            parent metadata object.
	 */
	public ClassAnnotationMetadata(final String className,
	 ...
	 * 
	 * @param methodAnnotationMetadata
	 *            metadata of a method.
	 */
	public void addMethodAnnotationMetadata(
			final MethodAnnotationMetadata methodAnnotationMetadata) {
	 ...
	 * 
	 * @param fieldAnnotationMetadata
	 *            metadata of a field.
	 */
	public void addFieldAnnotationMetadata(
			final FieldAnnotationMetadata fieldAnnotationMetadata) {
	 ...
	 * 
	 * @param cType
	 *            a type from enum class ClassType.
	 ...
	 * 
	 * @param messageDriven
	 *            attributes of message driven bean.
	 */
	...
	public String toString() {
		...
		concatStringBuilder("aroundInvokeMethodsMetadata",
				aroundInvokeMethodsMetadata, sb);
		...
		concatStringBuilder("transactionManagementType",
				transactionManagementType, sb);

		// transactionAttributeType
		concatStringBuilder("transactionAttributeType",
				transactionAttributeType, sb);

		// annotation Interceptors
		concatStringBuilder("annotationInterceptors", annotationInterceptors,
				sb);
		...
		concatStringBuilder("javaxPersistencePersistenceContexts",
				javaxPersistencePersistenceContexts, sb);

		// javaxPersistencePersistenceUnits
		concatStringBuilder("javaxPersistencePersistenceUnits",
				javaxPersistencePersistenceUnits, sb);
	...
	/**
	 * the &#64;{@link javax.ejb.RemoteHome} class name.
	...
	/**
	 * the &#64;{@link javax.ejb.LocalHome} class name.
	 ...
	 * @return transaction management type from.
	 ...
	 */
	public void setTransactionManagementType(
			final TransactionManagementType transactionManagementType) {
	 ...
	 */
	public void setTransactionAttributeType(
			final TransactionAttributeType transactionAttributeType) {
		this.transactionAttributeType = transactionAttributeType;
	}

	/**
	 * Object representing list of &#64;{@link javax.interceptor.Interceptors}.
	...
	/**
	 * Sets the object representing the &#64;{@link javax.interceptor.Interceptors}
	 * annotation.
	 * 
	 * @param annotationInterceptors
	 *            list of classes
	 */
	public void setAnnotationsInterceptors(
			final JInterceptors annotationInterceptors) {
		this.annotationInterceptors = annotationInterceptors;
	}

	/**
	 * the &#64;{@link javax.ejb.ApplicationException} annotation.
	...
	/**
	 * Sets the object representing the &#64;{@link javax.ejb.ApplicationException}
	 * annotation.
	 * 
	 ...
	 * classes).
	 * 
	 * @param externalUserInterceptors
	 *            list of interceptors that enhancer will use.
	 */
	public void setExternalUserInterceptors(
			final Map<InterceptorType, List<JClassInterceptor>> externalUserInterceptors) {
	...
	/**
	 * the list of methods metadata with annotation &#64;{@link javax.interceptor.AroundInvoke}.
	 ...
	 * @param aroundInvokeMethodMetadata
	 *            the method.
	 */
	public void addAroundInvokeMethodMetadata(
			final MethodAnnotationMetadata aroundInvokeMethodMetadata) {
	...
	/**
	 *  the methods metadata with annotation &#64;{@link javax.annotation.PostConstruct}.
	 ...
	 * 
	 * @param postConstructMethodMetadata
	 *            the method.
	 */
	public void addPostConstructMethodMetadata(
			final MethodAnnotationMetadata postConstructMethodMetadata) {
		checkLifeCycleDuplicate(postConstructMethodMetadata,
	 ...
	 *            method to check
	 * @param itcType
	 *            the type of interceptor (used for the error)
	 * @param existingList
	 *            current list of methods
	 */
	private void checkLifeCycleDuplicate(
			final MethodAnnotationMetadata postConstructMethodMetadata,
			final InterceptorType itcType,
			final List<MethodAnnotationMetadata> existingList) {
		// First case : not inherited
		ClassAnnotationMetadata wantToAddClassMetadata = postConstructMethodMetadata
				.getClassAnnotationMetadata();
		if (postConstructMethodMetadata.isInherited()) {
			wantToAddClassMetadata = postConstructMethodMetadata
		...
		for (MethodAnnotationMetadata method : existingList) {
			...
			if (compareMetaData.equals(wantToAddClassMetadata)) {
				throw new InterceptorsValidationException("Class "
						+ getClassName() + " has already a " + itcType
						+ " method which is " + method.getMethodName()
						+ ", cannot set new method "
	...
	/**
	 * the methods metadata with annotation &#64;{@link javax.annotation.PreDestroy}.
	 ...
	 * 
	 * @param preDestroyMethodMetadata
	 *            the method.
	 */
	public void addPreDestroyMethodMetadata(
			final MethodAnnotationMetadata preDestroyMethodMetadata) {
		checkLifeCycleDuplicate(preDestroyMethodMetadata,
				InterceptorType.PRE_DESTROY, getPreDestroyMethodsMetadata());
		this.preDestroyMethodsMetadata.addFirst(preDestroyMethodMetadata);
	}

	/**
	 * the methods metadata with annotation &#64;{@link javax.ejb.PostActivate}.
	 ...
	 * 
	 * @param postActivateMethodMetadata
	 *            the method.
	 */
	public void addPostActivateMethodMetadata(
			final MethodAnnotationMetadata postActivateMethodMetadata) {
		checkLifeCycleDuplicate(postActivateMethodMetadata,
				InterceptorType.POST_ACTIVATE, getPostActivateMethodsMetadata());
		this.postActivateMethodsMetadata.addFirst(postActivateMethodMetadata);
	}

	/**
	 * the method metadata with annotation &#64;{@link javax.ejb.PrePassivate}.
	 ...
	 * 
	 * @param prePassivateMethodMetadata
	 *            the method.
	 */
	public void addPrePassivateMethodMetadata(
			final MethodAnnotationMetadata prePassivateMethodMetadata) {
		checkLifeCycleDuplicate(prePassivateMethodMetadata,
	...
	public boolean isInterceptor() {
		return (aroundInvokeMethodsMetadata != null && aroundInvokeMethodsMetadata
				.size() > 0)
				|| (postConstructMethodsMetadata != null && postConstructMethodsMetadata
						.size() > 0)
				|| (preDestroyMethodsMetadata != null && preDestroyMethodsMetadata
						.size() > 0)
				|| (prePassivateMethodsMetadata != null && prePassivateMethodsMetadata
						.size() > 0)
				|| (postActivateMethodsMetadata != null && postActivateMethodsMetadata
						.size() > 0);
	}

	/**
	 * jEjbEJBs list representing &#64;{@link javax.ejb.EJBs}
	 *         annotation.
	 * @return jEjbEJBs list representing &#64;{@link javax.ejb.EJBs}
	 *         annotation.
	 */
	 ...
	 * 
	 * @param jEjbEJBs
	 *            list representing javax.ejb.EJBs annotation.
	 */
	...
	/**
	 * JAnnotationResources list representing &#64;{@link javax.annotation.Resources}
	 *         annotation.
	 * @return JAnnotationResources list representing &#64;{@link javax.annotation.Resources}
	 *         annotation.
	 */
	 ...
	 * 
	 * @param jAnnotationResources
	 *            list representing javax.annotation.Resources annotation.
	 */
	public void setJAnnotationResources(
			final List<JAnnotationResource> jAnnotationResources) {
		this.jAnnotationResources = jAnnotationResources;
	}

	/**
	 * javaxPersistencePersistenceContexts list representing &#64;{@link javax.persistence.PersistenceContexts}
	 *         annotation.
	 ...
	 * 
	 * @param javaxPersistencePersistenceContexts
	 *            list representing &#64;{@link javax.persistence.PersistenceContexts}
	 *            annotation.
	 */
	public void setJavaxPersistencePersistenceContexts(
			final List<JavaxPersistenceContext> javaxPersistencePersistenceContexts) {
		this.javaxPersistencePersistenceContexts = javaxPersistencePersistenceContexts;
	}

	/**
	 * javaxPersistencePersistenceUnits list representing &#64;{@link javax.persistence.PersistenceUnits}
	 *         annotation.
	 * @return javaxPersistencePersistenceUnits list representing &#64;{@link javax.persistence.PersistenceUnits}
	 *         annotation.
	 */
	 ...
	 * 
	 * @param javaxPersistencePersistenceUnits
	 *            list representing &#64;{@link javax.persistence.PersistenceUnits}
	 *            annotation.
	 */
	public void setJavaxPersistencePersistenceUnits(
			final List<JavaxPersistenceUnit> javaxPersistencePersistenceUnits) {
